...
public class AppLanguageSettings {
    ...
    public static final String PATH_DATA     = "./data/";   // revert to ./data for NetBeans
    public static final String PATH_WORK     = "./work/";   // revert to ./work for NetBeans
    public static final String PATH_IMAGES   = "./images/"; // revert to ./images for NetBeans
